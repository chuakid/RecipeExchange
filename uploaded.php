	...
	<main>
		...
		<section id="otherrecipes">
			...
			<section class="recipes">
				<?php 
				$query = "SELECT b.imageext,b.id, a.displayName, b.name, avg(c.stars) as stars FROM user as a JOIN recipe as b ON b.submitter = a.id LEFT JOIN review as c ON c.recipe = b.id WHERE b.submitter= '$userid' GROUP BY b.id ORDER BY stars";
