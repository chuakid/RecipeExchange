...
<head>
	...
	<link href="_css/reported.css" rel="stylesheet">
	...
	<main>
		<section id="reported">
			...
			<section class="recipes">
				<?php 
				$query = "SELECT b.imageext,b.id, a.displayName, b.name, avg(c.stars) as stars FROM user as a JOIN recipe as b ON b.submitter = a.id LEFT JOIN review as c ON c.recipe = b.id WHERE b.status = 'reported' GROUP BY b.id";
